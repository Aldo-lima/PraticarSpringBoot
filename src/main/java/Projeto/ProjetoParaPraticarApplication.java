...
public class ProjetoParaPraticarApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		Category cat1 = new Category(null, "eletronoco");
		Category cat2 = new Category(null, "Books");
		
		Product p1 = new Product(null, "TV", 2200.00, cat1);
		Product p2 = new Product(null, "livro", 2200.00, cat2);
		Product p3 = new Product(null, "PS5", 2200.00, cat1);
		Product p4 = new Product(null, "livro2", 2200.00, cat2);
